...
export class RoomSocketService {
    ...
    public connect = () => {
        ...
        this._socket.on(CONNECTION_SUCCESS, async ({socketId}: { socketId: string }) => {
            ...
            async ({params}: {
                ...
                producerTransport.on(
                    ...
                    async ({dtlsParameters}, callback, errback) => {
                        await this.onConnectedProducerTransport(dtlsParameters, callback, errback)
                    }
                );

                producerTransport.on("produce", async (parameters, callback, errback) => {
                    await this.onProducedProducerTransport(parameters, callback, errback)
                });
    ...
    private onProducedProducerTransport = async (
        parameters: { kind: MediaKind; rtpParameters: RtpParameters; appData: Record<string, unknown> },
